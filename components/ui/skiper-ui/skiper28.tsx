    ...
    <ReactLenis root>
      ...
      >
        ...
        <div className=" grid grid-cols-2 absolute w-full top-82  items-center">
          ...
          <h1 className={`text-[140px]  px-7 ${bodoniModa.className} `} >SATWIK</h1>
        </div>
        ...
        >
          <motion.div
            ...
            className="font-geist  bg-amber-500 w-full max-w-4xl text-center text-6xl font-bold tracking-tighter text-[#ff5800]"
          >
